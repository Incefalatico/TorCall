...
def sign_handshake(
    ...
    (``context_v2 + nonce + ephemeral``); otherwise the legacy v1 form
    (``context_v1 + ephemeral``) is produced for backward compatibility.
...
def verify_handshake(
    ...
    embedded timestamp must be fresh); otherwise the legacy v1 form is
    verified.
    ...
    Returns:
        True if the signature is valid (and fresh, for v2), False
